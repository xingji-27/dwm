...
static const Rule rules[] = {
    ...
    { NULL,                  NULL,                "Steam - 新闻",    0,            1,          0,          0,        -1,      0}, // steam新闻           浮动
    { NULL,                  NULL,                "好友列表",        0,            1,          0,          0,        -1,      0}, // steam好友           浮动
    ...
    {"Cider",                NULL,                 NULL,             1 << 5,       0,          0,          1,        -1,      1}, // cider      tag ->  无边框
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,    XK_F10,    spawn, SHCMD("~/scripts/screenkey.sh")},/* siper F10        | 打开/关闭键盘输入显示  */

    { MODKEY,              XK_d,      spawn, SHCMD("rofi -show drun -theme ~/.config/rofi/launchers/type-1/style-5.rasi") }, /* super d       | rofi: 执行drun   */
    { MODKEY|ShiftMask,    XK_d,      spawn, SHCMD("rofi -show run -theme ~/.config/rofi/launchers/type-1/style-5.rasi") },  /* super shift d | rofi: 执行run    */
    { MODKEY,              XK_p,      spawn, SHCMD("~/scripts/call_rofi.sh custom") },                          /* super p          | rofi: 执行自定义脚本   */
    { MODKEY|ShiftMask,    XK_p,      spawn, SHCMD("~/.config/rofi/powermenu/type-2/powermenu.sh") },           /* super shift p    | rofi: 执行powermenu    */
    ...
    { MODKEY,              XK_F9,     spawn, SHCMD("~/scripts/cava.sh") },                                      /* super F9         | 打开cava               */
